defmodule TdsIssuesTest do
  ...
  test "should return first error from token stream then auto log the rest of errors",
       context do
  ...
  test "should interprete correctly colmetadata type_info for text columns",
       context do
